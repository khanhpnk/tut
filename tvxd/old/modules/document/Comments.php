...
if(isset($_POST['subup'])&& $_POST['subup'] == 1) {
	...
	if(!$err) {
		//upload file attach
		$db->sql_query("INSERT INTO ".$prefix."_document_comments (newsid, alanguage, content, name, email, time, status) VALUES ($newsid, '$currentlang', '$content', '$name', '$email', ".time().", 0)");
		//fixweight_cat();
