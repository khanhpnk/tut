...
$result = $db->sql_query("SELECT c.title, c.parent, n.id , n.code, n.catid, n.title, n.permalink, n.guid, n.alanguage, n.time, n.hometext, n.bodytext, n.seo_title, n.seo_description, n.seo_keyword, n.seo_tag, n.fattach, n.link_extend , n.fattach_intro, n.othershow, n.images, n.image_slide, n.imgtext, n.source, n.active, n.imgshow, n.image_highlight, n.hits, n.hits_download, n.nstart, n.news_type, n.special, n.user_id, u.folder, u.fullname, n.price FROM " . $prefix . "_document AS n," . $prefix . "_document_cat AS c," . $prefix . "_user AS u  WHERE $where n.catid=c.catid AND n.user_id=u.id AND n.alanguage='$currentlang'");

if ($db->sql_numrows($result) != 1) {
    header("Location: " . url_sid("index.php") . "");
}

list($cattitle, $parent, $id, $code, $catid, $title, $permalink, $guid, $alanguage, $time, $hometext, $bodytext, $seo_title, $seo_description, $seo_keyword, $seo_tag, $fattach, $link_extend, $fattach_intro, $othershow, $images, $image_slide, $imgtext, $source, $active, $imgshow, $image_highlight, $hits, $hits_download, $nstart, $news_type, $special, $user_id, $folder, $fullname, $price) = $db->sql_fetchrow($result);
...
temp_document_detail($id, $code, $title, $time, $hometext, $bodytext, $fattach, $othershow, $document_img, $imgtext, $new_others, $new_others2, $source, $document_tid, $seo_title, $seo_description, $seo_keyword, $tags, $hits, $comment, $comment_content, $fattach_intro, $hits_download, $folder, $fullname, $fattach, $link_extend, $price);
