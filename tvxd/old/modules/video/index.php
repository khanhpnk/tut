...
echo "<div class=\"module-video-content fl\"><div class=\"module-video-title\"><div class=\"video-breakcoup fl\">"._MODTITLE."</div><div class=\"cl\"></div></div>";
	...
	echo '<div class="video-hot-tool"><div class="fl"><div class="fb-like" data-href="'.$urlsite.'/'.$_SERVER['REQUEST_URI'].'" data-layout="button" data-action="like" data-show-faces="true" data-share="true"></div></div><div class="fr">';
	
	
if (!defined('iS_USER') || !isset($userInfo) || !isset($_SESSION[USER_SESS])){
	echo '<a class="btn_download" target="_blank" href="'.url_sid("index.php?f=user&do=login").'">Tải bản video đầy đủ</a>';
}
else
{
	echo '<a class="btn_download" target="_blank" href='.$link_extend.'>Tải bản video đầy đủ</a>';
}
$json_output = file_get_contents("http://gdata.youtube.com/feeds/api/videos/$links_video?v=2&alt=json");
...
//echo $view_count;
	echo '</div><div class="video-hot-view fr"><span class="icon-eye-open"></span> '.$view_count.'</div></div>';
