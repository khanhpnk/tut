...
function system_report($content, $redirect)
{
    ...
    <table border="0" width="100%" cellpadding="0" style="border-collapse: collapse; margin-top: 150px">
        <tr>
            <td align="center">
                <table border="1" bgcolor="#FFFFFF" cellpadding="5" style="border-collapse: collapse" width="65%"
                       bordercolor="#035683">
                    <tr>
                        <td bgcolor="#1E84BC" background="images/blbg.gif" class="titlearl"><b><font color="#FFFFFF">Thông
                                    báo từ hệ thống....</font></b></td>
                    </tr>
                    <tr>
                        <td style="padding: 10px" class="titlearl" align="center"><?php echo $content; ?></td>
                    </tr>
                </table>
            </td>
        </tr>
...
$config_server = array(
    ...
    'username' => 'tvxdnet_data', // Tên đăng nhập vào cơ sở dữ liệu
    'password' => 'tHBmLGs6', //WMOX9iMLLK3 Mật khẩu vào cơ sở dữ liệu
    'database' => 'tvxdnet_data', // Database sử dụng
