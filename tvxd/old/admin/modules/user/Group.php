...
while(list($id,$title, $sale, $sale_card, $permission, $active) = $db->sql_fetchrow($result)) {
	...
	echo "<td align=\"center\" class=\"row3\"><a class=\"fancybox30 fancybox.iframe\" href=\"?f=$adm_modname&do=editgroup&id=$id\" info=\""._EDIT."\"><img border=\"0\" src=\"images/edit.png\"></a></td>\n";
