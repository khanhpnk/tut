...
if($db->sql_numrows($resultspadmin) == 1) {
	...
	if(!in_array($idsuperadmin, $super_admin))
...
if(isset($_POST['subup']) && $_POST['subup'] == 1) {
	...
	if($password !="" && (strlen($password) < 6 || strlen($password) > 25 || strrpos($password,' ') > 0)) {
...
echo "<td class=\"row3\">$err_pass<input type=\"text\" name=\"password\" value=\"\" size=\"30\"><i>Lưu ý mật khẩu lớn hơn 6 và nhỏ hơn 25 ký tự</i></td>\n";
echo "</tr>\n";
