...
if($db->sql_numrows($result) > 0) {
	...
	echo "<tr>\n";
	echo "<td class=\"row1sd\">"._NAME."</td>\n";
	echo "<td class=\"row3sd\" align=\"center\">"._CUSTOM_TITLE."</td>\n";
	echo "<td class=\"row1sd\" align=\"center\" width=\"100\">"._VIEW."</td>\n";
	echo "<td class=\"row3sd\" align=\"center\" width=\"60\">"._STATUS."</td>\n";
