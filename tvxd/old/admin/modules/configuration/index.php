...
//if(defined('iS_RADMIN')) {
	...
	if(isset($_POST['submit']) && $_POST['submit'] !="") {
		...
		$site_today = addcslashes($_POST['site_today']);
		...
		$content .= "\$txtpartnerid = '$config_txtpartnerid';\n";
		$content .= "\$txtsignal = '$config_txtsignal';\n";
...
echo "<tr><td class=\"row1\"><b>Số lần login:</b> (s)</td><td class=\"row2\"><input type=\"text\" name=\"config62\" value=\"$blockadm\" size=\"70\"><br><i>Nếu số lần truy cập liên tục tài khoản không đúng vượt quá $blockadm, tài khoản sẽ bị khóa</i></td></tr>\n";
	...
	echo "</td></tr>";
	echo "<tr><td class=\"row1\"><b>"._TODAY.":</b></td><td class=\"row2\"><input type=\"text\" name=\"site_today\" value=\"$site_today\" size=\"15\"></td></tr>\n";
	...
	//config ketnoipay
	echo "<tr><td class=\"row1\"><b>"._TXT_PARTNER_ID.":</b></td><td class=\"row3\"><input type=\"text\" name=\"config_txtpartnerid\" value=\"$txtpartnerid\" size=\"30\"></td></tr>\n";
	echo "<tr><td class=\"row1\"><b>"._TXT_SIGNAL.":</b></td><td class=\"row3\"><input type=\"text\" name=\"config_txtsignal\" value=\"$txtsignal\" size=\"30\"></td></tr>\n";
