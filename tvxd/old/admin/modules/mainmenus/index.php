...
/*if($ajax_active == 1) {	
	...
	switch($active) {
		case 1: $active = "<a href=\"?f=$adm_modname&do=status&type=$menu_type&id=$mid&stat=0\" info=\""._DEACTIVATE."\"><i class=\"fa fa-check-circle fa-lg fa-green\"></i></a>"; break;
		case 0: $active = "<a href=\"?f=$adm_modname&do=status&type=$menu_type&id=$mid&stat=1\" info=\""._ACTIVE."\"><i class=\"fa fa-minus-circle fa-lg fa-red\"></i></a>"; break;
	}	
//}

switch($target) {
	case 1: $target = "<i class=\"fa fa-check fa-lg\"></i>"; break;	
	case 0: $target = "<i class=\"fa fa-check fa-lg fa-red\"></i>"; break;	
}	
...
echo "<td align=\"center\" class=\"row1\"><a href=\"?f=$adm_modname&do=edit&menu_type=$menu_type&mid=$mid\" info=\""._EDIT."\"><i class=\"fa fa-pencil-square-o fa-lg\"></i></a></td>\n";
//if($ajax_active == 1) {
...
//} else {
	echo "<td align=\"center\" class=\"row1\"><a href=\"?f=$adm_modname&do=delete&menu_type=$menu_type&mid=$mid\" info=\""._DELETE."\" onclick=\"return confirm('"._DELETEASK."');\"><i class=\"fa fa-trash-o fa-lg\"></i></td>\n";
//}
echo childcat($mid);
}
...
function childcat($mid, $text="&nbsp;&nbsp;") {
	...
	if($db->sql_numrows($result) > 0 ) {
		...
		while(list($mid, $title, $active, $weight, $url, $target) = $db->sql_fetchrow($result)) {
			...
			//} else {
				switch($active) {
					case 1: $active = "<a href=\"?f=$adm_modname&do=status&id=$mid&stat=0\" info=\""._DEACTIVATE."\"><i class=\"fa fa-check-circle fa-lg fa-green\"></i></a>"; break;
					case 0: $active = "<a href=\"?f=$adm_modname&do=status&id=$mid&stat=1\" info=\""._ACTIVE."\"><i class=\"fa fa-minus-circle fa-lg fa-red\"></i></a>"; break;
				}
		//	}
			switch($target) {
				case 1: $target2 = "<i class=\"fa fa-check fa-lg\"></i>"; break;	
				case 0: $target2 = "<i class=\"fa fa-check fa-lg fa-red\"></i>"; break;	
			}	
			...
			$treeTemp .= "<td align=\"center\" class=\"row1\"><a href=\"?f=$adm_modname&do=edit&menu_type=$menu_type&mid=$mid\" info=\""._EDIT."\"><i class=\"fa fa-pencil-square-o fa-lg\"></i></a></td>\n";
			$treeTemp .= "<td align=\"center\" class=\"row3\"><a href=\"?f=$adm_modname&do=delete&menu_type=$menu_type&mid=$mid\" info=\""._DELETE."\" onclick=\"return confirm('"._DELETEASK."');\"><i class=\"fa fa-trash-o fa-lg\"></i></td>\n";
			$treeTemp .= "	</tr>\n";
