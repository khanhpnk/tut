...
@require_once(RPATH.'includes/phpmailer/PHPMailerAutoload.php');
...
function resize_image($title, $image, $imgin, $imgout, $width, $height){
	global $urlsite;
	$imgin		= $imgin."/".$image;
	...
	$image= "<img title=\"$title\" alt=\"$title\" width=\"$width\" height=\"$height\" src=\"$image\" />";
	return $image;
}
